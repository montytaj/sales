<x-app-layout>
    <div class="min-vh-75 d-flex align-items-center justify-content-center py-5">
        <div class="text-center max-w-lg mx-auto card-custom p-5">
            ...
            <h1 class="display-5 font-extrabold text-slate-900 mb-2">403</h1>
            <h2 class="h4 font-bold text-slate-800 mb-3">{{ __('general.access_denied') ?? 'غير مصرح للوصول' }}</h2>
            <p class="text-muted fs-6 mb-4">
                {{ __('general.no_permission_message') ?? 'عفواً، لا تملك الصلاحيات الكافية للوصول إلى هذه الصفحة أو تنفيذ هذا الإجراء.' }}
            </p>
