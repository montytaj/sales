<x-app-layout>
    <x-slot name="breadcrumbs">
        @php
            $breadcrumbs = [
                ...
                ['label' => __('suppliers.edit_supplier')]
            ];
        @endphp
    </x-slot>
    ...
    <x-slot name="header">
        <h2 class="h4 mb-0 font-bold text-dark">
            <i class="bi bi-pencil-square text-primary me-2"></i>{{ __('suppliers.edit_supplier') }}: {{ $supplier->name }}
        </h2>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('suppliers.update', $supplier) }}">
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select name="rating" id="rating" class="form-select" required>
                                    <option value="5" {{ old('rating', $supplier->rating) == 5 ? 'selected' : '' }}>⭐⭐⭐⭐⭐ 5 نجوم (ممتاز)</option>
                                    <option value="4" {{ old('rating', $supplier->rating) == 4 ? 'selected' : '' }}>⭐⭐⭐⭐ 4 نجوم (جيد جداً)</option>
                                    <option value="3" {{ old('rating', $supplier->rating) == 3 ? 'selected' : '' }}>⭐⭐⭐ 3 نجوم (متوسط)</option>
                                    <option value="2" {{ old('rating', $supplier->rating) == 2 ? 'selected' : '' }}>⭐⭐ 2 نجوم (مقبول)</option>
                                    <option value="1" {{ old('rating', $supplier->rating) == 1 ? 'selected' : '' }}>⭐ 1 نجمة (ضعيف)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" name="phone_secondary" id="phone_secondary" class="form-control" value="{{ old('phone_secondary', $supplier->phone_secondary) }}">
                            </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="cr_number" id="cr_number" class="form-control" value="{{ old('cr_number', $supplier->cr_number) }}">
                            </div>

                            <div class="col-12 col-md-6">
                                <label for="vat_number" class="form-label font-semibold">{{ __('suppliers.vat_number') }}</label>
                                <input type="text" name="vat_number" id="vat_number" class="form-control" value="{{ old('vat_number', $supplier->vat_number) }}">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="services_provided" id="services_provided" rows="2" class="form-control">{{ old('services_provided', $supplier->services_provided) }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="is_active" value="1" id="is_active" {{ old('is_active', $supplier->is_active) ? 'checked' : '' }}>
