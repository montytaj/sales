<x-app-layout>
    <x-slot name="breadcrumbs">
        @php
            $breadcrumbs = [
                ...
                ['label' => __('branches.create_branch')]
            ];
        @endphp
    </x-slot>
    ...
    <x-slot name="header">
        <h2 class="h4 mb-0 font-bold text-dark">
            <i class="bi bi-building-add text-primary me-2"></i>{{ __('branches.create_branch') }}
        </h2>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('branches.store') }}">
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" placeholder="مثال: BR-02" required autofocus>
                                @error('code')
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="اسم الفرع" required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="is_main" value="1" id="is_main" {{ old('is_main') ? 'checked' : '' }}>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary px-4">
                                <i class="bi bi-check-lg me-1"></i>حفظ الفرع
                            </button>
                        </div>
                    </form>
                </div>
